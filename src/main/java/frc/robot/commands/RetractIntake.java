...
public class RetractIntake extends CommandBase {
  ...
  public void initialize() {
    retractIntake.setIntakeMotorCurrentLimit(Constants.IntakeConstants.ToiletIntakeCurrentLimit, Constants.IntakeConstants.ToiletIntakeTargetVoltage);
  }
  ...
  public void execute() {
    ...
    retractIntake.setIntakeSpeed(output);
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    retractIntake.setIntakeSpeed(0);
  }
