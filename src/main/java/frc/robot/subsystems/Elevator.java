...
import frc.robot.CrevoLib.util.DutyCycleEncoderVelocity;

public class Elevator extends SubsystemBase {
  private CANSparkMax mElevatorMotor;
  private SparkMaxPIDController m_pidController;
  private DutyCycleEncoder mElevatorEncoder;
  private DutyCycleEncoderVelocity mElevatorEncoderVelocity;


  public double kP, kI, kD, kIz, kFF, kMaxOutput, kMinOutput, maxRPM, maxVel, minVel, maxAcc, allowedErr;
  
  public Elevator() {
    mElevatorMotor = new CANSparkMax(ElevatorConstants.ELEVATOR_MOTOR_ID, MotorType.kBrushless);

    mElevatorMotor.restoreFactoryDefaults();

    m_pidController = mElevatorMotor.getPIDController();
    
    mElevatorEncoder = new DutyCycleEncoder(ElevatorConstants.ENCODER_CHANNEL);

    mElevatorEncoderVelocity = new DutyCycleEncoderVelocity(ElevatorConstants.ENCODER_CHANNEL);
